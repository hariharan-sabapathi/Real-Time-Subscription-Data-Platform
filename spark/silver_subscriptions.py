...
spark = SparkSession.builder \
    .appName("SilverSubscriptionsStreaming") \
...
bronze_path = "/delta/bronze/subscriptions"
current_path = "/delta/silver/subscriptions_current"
...
def upsert_to_silver(batch_df, batch_id):
    ...
    silver_df = batch_df.select(
        ...
        col("after.plan_id").alias("plan_id"),
    ...
    window = Window.partitionBy("subscription_id") \
...
query = bronze_df.writeStream \
    ...
    .option("checkpointLocation", "/delta/checkpoints/silver_subscriptions") \
    .outputMode("append") \
    .start()
